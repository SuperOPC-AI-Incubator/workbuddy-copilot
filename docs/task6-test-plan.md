...
| Delivery locking   | Creation-order fetch vs reverse-UUID ack      | One student-scoped transaction lock prevents deadlock; both calls finish and all rows reach a valid terminal state                |
